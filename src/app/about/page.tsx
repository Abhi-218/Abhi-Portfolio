...
export default function About() {
  ...
  useEffect(() => {
   ...
   const code = `const learningJourney = {
  current: "DevOps",
  status: "In Progress",
  nextUpdate: "Soon after completion 🚀"
};

const devOpsLearning = async () => {
  console.log("Learning DevOps... please wait ⏳");
  // Progress will be shown once completed!
};
`;
  ...
  const education = [
    {
      degree: "SSC And HSC",
      institution: "M N J PATEL MADHYAMIK SHALA",
      period: "2021-2023",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-4xl font-bold mb-6 relative">
            <span className="relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-500">
              About Me
            </span>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-16">
            ...
            <div className="flex-1">
              ...
              <p className="mb-6 text-slate-700 dark:text-slate-300">
                My approach combines clean code practices, CI/CD automation,
                infrastructure as code, and thoughtful cloud architecture to
                create scalable, maintainable applications. I&apos;m dedicated
                to continuous learning and staying at the forefront of both
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  While I don&apos;t have traditional company experience yet,
                  I&apos;ve focused on building a strong portfolio of
                ...
                >
                  ...
                  <div className="bg-white/50 dark:bg-gray-700/50 p-4 rounded-lg backdrop-blur-sm flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-2">
                      Developed with MERN stack and AWS
                    </p>
                  </div>
                </motion.div>
                ...
                {education.map((edu, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center mb-2">
                      <span className="text-sm text-slate-500 bg-white/50 dark:bg-gray-800/50 px-3 py-1 rounded-full">
                        {edu.period}
                      </span>
                    </div>
