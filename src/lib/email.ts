    ...
    <table style="max-width: 600px; margin: 0 auto; background:; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        ...
        <tr>
            <td style="padding: 20px; text-align: left; color: #333333;">
                ...
                <p>${path === 'signup' ? 'Thank you for registering up on <strong>Abhishek portfolio</strong>! To complete your registration and verify your account,' : 'You want to reset your password of <strong>Abhishek protfolio</strong> ,'} please use the verification code below:</p>
